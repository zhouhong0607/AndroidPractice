...
public class ChatActivity extends Activity
		implements com.stay4it.emoji.EmoticonView.OnEmoticonTapListener, OnClickListener
{
	...
	public void onEmoticonTap(String drawableId)
	{
		...
		// int id = ChatActivity.this.getResources().getIdentifier(source,
		...
		// }
		// };
		// CharSequence cs1 = Html.fromHtml("<img src='" + drawableSrc + "'/>",
		// imageGetter, null);
